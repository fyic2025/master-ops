...
export const BUSINESSES: Record<BusinessCode, Business> = {
  ...
  teelixir: {
    ...
    navigation: [
      ...
      { name: 'UL Orders', href: '/unleashed/orders', icon: ShoppingCart },
      { name: 'UL Customers', href: '/unleashed/customers', icon: Users },
      { name: 'UL Purchasing', href: '/unleashed/purchasing', icon: Truck },
      { name: 'UL Invoices', href: '/unleashed/invoices', icon: FileText },
